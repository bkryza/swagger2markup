...
import io.github.swagger2markup.gitbook.OperationExtensions;
...
public class Application implements Runnable{
    ...
    private Swagger2MarkupExtensionRegistry registry;
    ...
    public void run() {
        ...
        registry = new Swagger2MarkupExtensionRegistryBuilder()
                .withPathsDocumentExtension(new OperationExtensions())
                .build();
        ...
        //converterBuilder.withExtensionRegistry(registry);
